...
const chains = { total: 2, items: [
  ...
  { chainId: 143, name: 'Monad', shortName: 'mon', isTestnet: false, nativeSymbol: 'MON', status: 'active', state: 'hot', catalogEndpoints: 1, endpoints: 1, active: 1, head: 20, ingressTotal: 4, cacheHitsTotal: 3, cacheLookupsTotal: 4 },
] };
