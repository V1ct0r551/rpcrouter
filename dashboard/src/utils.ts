...
export const statusMeta = (state: ChainState) => ({ active: ['#0ca30c', 'Active'], probation: ['#fab219', 'Probation'], cooling: ['#ec835a', 'Cooling'], error: ['#d03b3b', 'Error'], dormant: ['#8b8982', 'Dormant'], disabled: ['#8b8982', 'Disabled'] } as Record<string, [string,string]>)[state] || ['#8b8982', state];
